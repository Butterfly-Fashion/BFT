...
export default async function ProductsPage({ searchParams }: Props) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="flex gap-2 mb-10 overflow-x-auto pb-1 sm:overflow-visible sm:flex-wrap sm:pb-0">
        <Link
          href="/products"
      ...
      {(() => {
        ...
        return (
          <div className="flex gap-2 mb-8 -mt-6 overflow-x-auto pb-1 sm:overflow-visible sm:flex-wrap sm:pb-0">
            {visible.map((name) => {
              ...
              return (
                <Link
                  ...
                  className={`shrink-0 px-3 py-1.5 rounded-full text-xs font-medium border transition-colors duration-150 ${
                    category === name
