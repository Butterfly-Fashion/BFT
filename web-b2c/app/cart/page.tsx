  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 pb-20 md:pb-0">
      ...
      {freeShippingRemaining > 0 && (
        <div className="bg-[#C41E3A]/8 border border-[#C41E3A]/20 rounded-xl px-4 py-3 mb-8 text-sm text-gray-700">
          Add{" "}
          <strong className="text-[#C41E3A]">{formatCAD(freeShippingRemaining)}</strong>{" "}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-semibold text-gray-900 leading-snug mb-0.5 line-clamp-2">
                    {item.name}
                  </h3>
                  {item.size && (
                    <p className="text-xs text-gray-400 mb-2">Size: {item.size}</p>
                  )}
                  <p className="text-sm font-bold text-gray-900">{formatCAD(item.price)}</p>
                </div>
                ...
                <div className="flex flex-col items-end justify-between">
                  ...
                  <div className="inline-flex items-center border border-gray-200 rounded-lg overflow-hidden">
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-50 text-sm font-medium"
                    >
                      −
                    </button>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-24">
            ...
            <div className="border-t border-gray-100 mt-5 pt-4 flex justify-between font-bold text-gray-900">
