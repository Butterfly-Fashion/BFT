...
<head>
  ...
  <title>Under Maintenance — World Fan Gear</title>
  <style>
...
<body>
  <div class="card">
    <div class="brand">World Fan Gear</div>
    <h1>We&rsquo;ll be back soon</h1>
    <p>Our store is temporarily down for maintenance. Please check back shortly.</p>
  </div>
</body>
</html>`;
