    ...
    items: [
      {
        ...
        a: "We carry seasonal and winter items (gloves, toques, scarves, masks), novelty and fidget toys, and trending variety accessories. New products are added regularly.",
      },
      {
