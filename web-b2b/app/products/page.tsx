...
export const metadata: Metadata = {
  ...
  description:
    "Browse the Butterfly Fashion Trading wholesale catalog — winter accessories, novelty & fidget toys, and trending variety goods with Item Codes and no minimum order. B2B pricing unlocks instantly with free registration. Ships from Toronto across Canada & the USA.",
